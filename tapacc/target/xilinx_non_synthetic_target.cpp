...
#include "xilinx_non_synthetic_target.h"
...
void XilinxNonSyntheticTarget::AddCodeForTopLevelFunc(ADD_FOR_FUNC_ARGS_DEF) {
...
void XilinxNonSyntheticTarget::AddCodeForTopLevelStream(
...
void XilinxNonSyntheticTarget::AddCodeForTopLevelAsyncMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
  if (!vitis_mode) {
...
void XilinxNonSyntheticTarget::AddCodeForTopLevelMmap(ADD_FOR_PARAMS_ARGS_DEF) {
  if (!vitis_mode) {
...
void XilinxNonSyntheticTarget::AddCodeForTopLevelScalar(
    ADD_FOR_PARAMS_ARGS_DEF) {
  if (vitis_mode) {
...
void XilinxNonSyntheticTarget::AddCodeForMiddleLevelStream(
    ADD_FOR_PARAMS_ARGS_DEF) {
  AddCodeForLowerLevelStream(ADD_FOR_PARAMS_ARGS);
  AddDummyStreamRW(ADD_FOR_PARAMS_ARGS, false);
}

void XilinxNonSyntheticTarget::AddCodeForMiddleLevelAsyncMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
  AddCodeForMiddleLevelScalar(ADD_FOR_PARAMS_ARGS);
}

void XilinxNonSyntheticTarget::AddCodeForMiddleLevelMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
  AddCodeForMiddleLevelScalar(ADD_FOR_PARAMS_ARGS);
}

void XilinxNonSyntheticTarget::AddCodeForMiddleLevelScalar(
    ADD_FOR_PARAMS_ARGS_DEF) {
...
void XilinxNonSyntheticTarget::AddCodeForLowerLevelStream(
    ADD_FOR_PARAMS_ARGS_DEF) {
...
void XilinxNonSyntheticTarget::AddCodeForLowerLevelAsyncMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
...
void XilinxNonSyntheticTarget::AddCodeForLowerLevelMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
...
void XilinxNonSyntheticTarget::RewriteTopLevelFunc(REWRITE_FUNC_ARGS_DEF) {
  throw std::runtime_error(
      "Synthetic target needs to be a lower task instead of a top-level task.");
}

void XilinxNonSyntheticTarget::RewriteMiddleLevelFunc(REWRITE_FUNC_ARGS_DEF) {
...
void XilinxNonSyntheticTarget::RewriteLowerLevelFunc(REWRITE_FUNC_ARGS_DEF) {
...
void XilinxNonSyntheticTarget::RewriteOtherFunc(REWRITE_FUNC_ARGS_DEF) {
  BaseTarget::RewriteOtherFunc(REWRITE_FUNC_ARGS);
  RewriteStreamDefinitions(REWRITE_FUNC_ARGS);
}

void XilinxNonSyntheticTarget::RewriteTopLevelFuncArguments(
...
void XilinxNonSyntheticTarget::RewriteMiddleLevelFuncArguments(
    REWRITE_FUNC_ARGS_DEF) {
  // Replace mmaps arguments with 64-bit base addresses.
  for (const auto param : func->parameters()) {
...
void XilinxNonSyntheticTarget::ProcessNonCurrentTask(
...
void XilinxNonSyntheticTarget::RewriteOtherFuncArguments(
    REWRITE_FUNC_ARGS_DEF) {}

void XilinxNonSyntheticTarget::RewritePipelinedDecl(REWRITE_DECL_ARGS_DEF,
                                                    const clang::Stmt* body) {
...
void XilinxNonSyntheticTarget::RewritePipelinedStmt(REWRITE_STMT_ARGS_DEF,
                                                    const clang::Stmt* body) {
  if (auto pipeline = llvm::dyn_cast<clang::TapaPipelineAttr>(attr)) {
    if (body) AddPipelinePragma(rewriter, pipeline, body);
  }
...
void XilinxNonSyntheticTarget::RewriteUnrolledStmt(REWRITE_STMT_ARGS_DEF,
                                                   const clang::Stmt* body) {
