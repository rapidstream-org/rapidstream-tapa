...
void XilinxNonSynthesizableTarget::AddCodeForTopLevelFunc(
    ADD_FOR_FUNC_ARGS_DEF) {
...
void XilinxNonSynthesizableTarget::AddCodeForTopLevelStream(
    ADD_FOR_PARAMS_ARGS_DEF) {
  if (vitis_mode) {
...
void XilinxNonSynthesizableTarget::AddCodeForTopLevelAsyncMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
  if (!vitis_mode) {
...
void XilinxNonSynthesizableTarget::AddCodeForTopLevelMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
  if (!vitis_mode) {
...
void XilinxNonSynthesizableTarget::AddCodeForTopLevelScalar(
    ADD_FOR_PARAMS_ARGS_DEF) {
  if (vitis_mode) {
...
void XilinxNonSynthesizableTarget::AddCodeForMiddleLevelStream(
    ADD_FOR_PARAMS_ARGS_DEF) {
  AddCodeForLowerLevelStream(ADD_FOR_PARAMS_ARGS);
  AddDummyStreamRW(ADD_FOR_PARAMS_ARGS, false);
}

void XilinxNonSynthesizableTarget::AddCodeForMiddleLevelAsyncMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
  AddCodeForMiddleLevelScalar(ADD_FOR_PARAMS_ARGS);
}

void XilinxNonSynthesizableTarget::AddCodeForMiddleLevelMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
  AddCodeForMiddleLevelScalar(ADD_FOR_PARAMS_ARGS);
}

void XilinxNonSynthesizableTarget::AddCodeForMiddleLevelScalar(
    ADD_FOR_PARAMS_ARGS_DEF) {
...
void XilinxNonSynthesizableTarget::AddCodeForLowerLevelStream(
    ADD_FOR_PARAMS_ARGS_DEF) {
...
void XilinxNonSynthesizableTarget::AddCodeForLowerLevelAsyncMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
...
void XilinxNonSynthesizableTarget::AddCodeForLowerLevelMmap(
    ADD_FOR_PARAMS_ARGS_DEF) {
...
void XilinxNonSynthesizableTarget::RewriteTopLevelFunc(REWRITE_FUNC_ARGS_DEF) {
  throw std::runtime_error(
      "Synthesizable target needs to be a lower task instead of a top-level "
      "task.");
}

void XilinxNonSynthesizableTarget::RewriteMiddleLevelFunc(
    REWRITE_FUNC_ARGS_DEF) {
...
void XilinxNonSynthesizableTarget::RewriteLowerLevelFunc(
    REWRITE_FUNC_ARGS_DEF) {
...
void XilinxNonSynthesizableTarget::RewriteOtherFunc(REWRITE_FUNC_ARGS_DEF) {
  BaseTarget::RewriteOtherFunc(REWRITE_FUNC_ARGS);
  RewriteStreamDefinitions(REWRITE_FUNC_ARGS);
}

void XilinxNonSynthesizableTarget::RewriteTopLevelFuncArguments(
    REWRITE_FUNC_ARGS_DEF) {
...
void XilinxNonSynthesizableTarget::RewriteMiddleLevelFuncArguments(
    REWRITE_FUNC_ARGS_DEF) {
  // Replace mmaps arguments with 64-bit base addresses.
  for (const auto param : func->parameters()) {
...
void XilinxNonSynthesizableTarget::ProcessNonCurrentTask(
...
void XilinxNonSynthesizableTarget::RewriteOtherFuncArguments(
    REWRITE_FUNC_ARGS_DEF) {}

void XilinxNonSynthesizableTarget::RewritePipelinedDecl(
    REWRITE_DECL_ARGS_DEF, const clang::Stmt* body) {
...
void XilinxNonSynthesizableTarget::RewritePipelinedStmt(
    REWRITE_STMT_ARGS_DEF, const clang::Stmt* body) {
  if (auto pipeline = llvm::dyn_cast<clang::TapaPipelineAttr>(attr)) {
    if (body) AddPipelinePragma(rewriter, pipeline, body);
  }
  rewriter.RemoveText(ExtendAttrRemovalRange(rewriter, attr->getRange()));
...
void XilinxNonSynthesizableTarget::RewriteUnrolledStmt(
    REWRITE_STMT_ARGS_DEF, const clang::Stmt* body) {
