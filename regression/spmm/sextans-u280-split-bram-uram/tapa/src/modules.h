...
void Relay_int(tapa::istream<int> & fifo_in,
...
void PEG(tapa::istream<int> & PE_inst,
...
void Selector(const int M,
              tapa::istreams<float_v8, 2> & fifo_in,
