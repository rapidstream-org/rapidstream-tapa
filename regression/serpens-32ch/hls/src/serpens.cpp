...
#pragma HLS pipeline II=1
        ...
        if (parameter_ready) {
            ...
            switch (i) {
                case 0: NUM_ITE = parameter_delay; break;
                case 1: M = parameter_delay; break;
                case 2: P32 = parameter_delay; break;
                case 3: K = parameter_delay; break;
                case 4: alpha_u = parameter_delay; break;
            }
            ++i;
...
#pragma HLS array_partition variable=local_B_pe0_pe1 cyclic factor=B_PARTITION_FACTOR
#pragma HLS array_partition variable=local_B_pe2_pe3 cyclic factor=B_PARTITION_FACTOR
#pragma HLS array_partition variable=local_B_pe4_pe5 cyclic factor=B_PARTITION_FACTOR
#pragma HLS array_partition variable=local_B_pe6_pe7 cyclic factor=B_PARTITION_FACTOR
...
#pragma HLS loop_tripcount min=1 max=49
            ...
            // fill onchip X
        read_X:
            for (ap_uint<14> j = 0; (j < WINDOW_SIZE_DIV_16) && (j < ((K + 15)>>4) - i*WINDOW_SIZE_DIV_16); ) {
...
#pragma HLS pipeline II=1
                ...
                fill_X_p:
                    for (ap_uint<5> k = 0; k < 16; ++k) {
                        local_B_pe0_pe1[HLS_REG(HLS_REG(j)) * 16 + k] = x_512_delay(k * 32 + 31, k * 32);
                        local_B_pe2_pe3[HLS_REG(HLS_REG(j)) * 16 + k] = x_512_delay(k * 32 + 31, k * 32);
                        local_B_pe4_pe5[HLS_REG(HLS_REG(j)) * 16 + k] = x_512_delay(k * 32 + 31, k * 32);
                        local_B_pe6_pe7[HLS_REG(HLS_REG(j)) * 16 + k] = x_512_delay(k * 32 + 31, k * 32);
                    }
                    ++j;
                }
            }
...
#pragma HLS dependence true variable=local_C_pe0 distance=DEP_DIST_LOAD_STORE
#pragma HLS dependence true variable=local_C_pe1 distance=DEP_DIST_LOAD_STORE
#pragma HLS dependence true variable=local_C_pe2 distance=DEP_DIST_LOAD_STORE
#pragma HLS dependence true variable=local_C_pe3 distance=DEP_DIST_LOAD_STORE
#pragma HLS dependence true variable=local_C_pe4 distance=DEP_DIST_LOAD_STORE
#pragma HLS dependence true variable=local_C_pe5 distance=DEP_DIST_LOAD_STORE
#pragma HLS dependence true variable=local_C_pe6 distance=DEP_DIST_LOAD_STORE
#pragma HLS dependence true variable=local_C_pe7 distance=DEP_DIST_LOAD_STORE
...
template <bool SEND_META>
void mux_Y(
           hls::stream<ap_uint<64> > & fifo_in0,
...
void merge_Y(
             ...
             hls::stream<ap_uint<64> > & fifo_in2,
             hls::stream<ap_uint<64> > & fifo_in3,
             hls::stream<ap_uint<64> > & fifo_in4,
             hls::stream<ap_uint<64> > & fifo_in5,
             hls::stream<ap_uint<64> > & fifo_in6,
             hls::stream<ap_uint<64> > & fifo_in7,
...
#pragma HLS pipeline II=1
            ...
            bool all_ready = x0_ready && x1_ready && x2_ready && x3_ready && x4_ready && x5_ready && x6_ready && x7_ready;
            if(all_ready) {
...
void comp_Y(
            hls::stream<ap_uint<512> > & fifo_Y_read_in,
            hls::stream<ap_uint<512> > & fifo_Y_pe_in,
            hls::stream<ap_uint<512> > & fifo_Y_out,
            const ap_uint<32> beta_u
            ) {
#pragma HLS inline off
    bool M_ready = false;
    ap_uint<512> M512;
...
void serpens(
             ...
             const ap_uint<512> *edge_list_ch24,
             const ap_uint<512> *edge_list_ch25,
             const ap_uint<512> *edge_list_ch26,
             const ap_uint<512> *edge_list_ch27,
             const ap_uint<512> *edge_list_ch28,
             const ap_uint<512> *edge_list_ch29,
             const ap_uint<512> *edge_list_ch30,
             const ap_uint<512> *edge_list_ch31,
...
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe8 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe9 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe10 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe11 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe12 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe13 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe14 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe15 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe16 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe17 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe18 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe19 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe20 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe21 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe22 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe23 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe24 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe25 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe26 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe27 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe28 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe29 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe30 type=FIFO impl=SRL
#pragma HLS bind_storage variable=fifo_edge_list_ptr_pe31 type=FIFO impl=SRL
