...
//         }
		...
		rd_ptr: for(ap_uint<32> i_req = 0, i_resp = 0; i_resp <= num_ite;) {
#pragma HLS loop_tripcount min=1 max=800
#pragma HLS pipeline II=1
			if (i_req <= num_ite &&
					i_req < i_resp + 64 &&
...
void read_X(
            tapa::async_mmap<ap_uint<512> >& X,
            tapa::ostream<ap_uint<512> > & fifo_X,
            const ap_uint<32> K,
            const ap_uint<16> rp_time
            ) {
#pragma HLS inline off
...
//         }
		...
		rd_X: for(ap_uint<32> i_req = 0, i_resp = 0; i_resp < num_ite_X;) {
#pragma HLS loop_tripcount min=1 max=500000
#pragma HLS pipeline II=1
			if (i_req < num_ite_X &&
					i_req < i_resp + 64 &&
...
void mux_Y_true(
           tapa::istream<ap_uint<64> > & fifo_in0,
...
void merge_Y(
             ...
             tapa::istream<ap_uint<64> > & fifo_in2,
             tapa::istream<ap_uint<64> > & fifo_in3,
             tapa::istream<ap_uint<64> > & fifo_in4,
             tapa::istream<ap_uint<64> > & fifo_in5,
             tapa::istream<ap_uint<64> > & fifo_in6,
             tapa::istream<ap_uint<64> > & fifo_in7,
...
void read_Y(
            tapa::async_mmap<ap_uint<512> >& Y_in,
            tapa::ostream<ap_uint<512> > & fifo_Y,
            const ap_uint<32> M,
            const ap_uint<16> rp_time
            ) {
#pragma HLS inline off
...
//         }
		...
		rd_Y: for(ap_uint<32> i_req = 0, i_resp = 0; i_resp < num_ite_Y;) {
#pragma HLS loop_tripcount min=1 max=500000
#pragma HLS pipeline II=1
			if (i_req < num_ite_Y &&
					i_req < i_resp + 64 &&
...
void comp_Y(
            tapa::istream<ap_uint<512> > & fifo_Y_read_in,
            tapa::istream<ap_uint<512> > & fifo_Y_pe_in,
            tapa::ostream<ap_uint<512> > & fifo_Y_out,
...
void write_Y(
             tapa::istream<ap_uint<512> > & fifo_Y,
...
#pragma HLS loop_tripcount min=1 max=16
  ...
  //         }
        ...
        wr_y: for (ap_uint<32> i_req = 0, i_resp = 0; i_resp < num_ite_Y;) {
#pragma HLS loop_tripcount min=1 max=5000
#pragma HLS pipeline II=1
        if (i_req < num_ite_Y &&
            i_req < i_resp + 64 &&
...
void serpens(
            ...
            tapa::mmap<ap_uint<512>> vec_X,
            tapa::mmap<ap_uint<512>> vec_Y,
    ...
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe10("fifo_edge_list_ptr_pe10");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe11("fifo_edge_list_ptr_pe11");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe12("fifo_edge_list_ptr_pe12");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe13("fifo_edge_list_ptr_pe13");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe14("fifo_edge_list_ptr_pe14");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe15("fifo_edge_list_ptr_pe15");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe16("fifo_edge_list_ptr_pe16");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe17("fifo_edge_list_ptr_pe17");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe18("fifo_edge_list_ptr_pe18");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe19("fifo_edge_list_ptr_pe19");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe20("fifo_edge_list_ptr_pe20");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe21("fifo_edge_list_ptr_pe21");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe22("fifo_edge_list_ptr_pe22");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe23("fifo_edge_list_ptr_pe23");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe24("fifo_edge_list_ptr_pe24");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe25("fifo_edge_list_ptr_pe25");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe26("fifo_edge_list_ptr_pe26");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe27("fifo_edge_list_ptr_pe27");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe28("fifo_edge_list_ptr_pe28");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe29("fifo_edge_list_ptr_pe29");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe30("fifo_edge_list_ptr_pe30");
    tapa::stream<ap_uint<32>, 2> fifo_edge_list_ptr_pe31("fifo_edge_list_ptr_pe31");
