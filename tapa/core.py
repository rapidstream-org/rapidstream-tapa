...
class Program(  # TODO: refactor this class
    ...
    def __init__(
        ...
        floorplan_task_name_to_region_mapping: dict[str, str] | None = None,
    ) -> None:
        ...
        Args:
          ...
          floorplan_task_name_to_region_mapping: Mapping from slot task names to
        ...
        self.floorplan_task_name_to_region_mapping = (
