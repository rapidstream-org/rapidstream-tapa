...
void Add_internal(uint64_t n_int, tapa::istream<float>& a_int,
...
void Add(uint64_t n_int, tapa::istream<float>& a_int,
         tapa::istream<float>& b_int, tapa::ostream<float>& c_int) {
  Add_internal(n_int, a_int, b_int, c_int);
}
...
void Mmap2Stream(tapa::async_mmap<float>& mmap_ext, uint64_t n_ext,
                 tapa::ostream<float>& stream_ext) {
  Mmap2Stream_internal(mmap_ext, n_ext, stream_ext);
}
...
void VecAddMixed(tapa::mmap<float> a_array, tapa::mmap<float> b_array,
...
void UnusedTask(tapa::mmap<float> a_array, tapa::mmap<float> b_array,
                tapa::mmap<float> c_array, uint64_t n) {
  tapa::stream<float, 8> a_stream("a");
  tapa::stream<float, 8> b_stream("b");
  tapa::stream<float, 8> c_stream("c");
