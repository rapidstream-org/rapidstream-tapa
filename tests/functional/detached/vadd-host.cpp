...
void VecAddDetach(tapa::mmap<const float> a_array,
                  tapa::mmap<const float> b_array, tapa::mmap<float> c_array,
                  uint64_t n);
...
int main(int argc, char* argv[]) {
  ...
  int64_t kernel_time_ns = tapa::invoke(
      VecAddDetach, FLAGS_bitstream, tapa::read_only_mmap<const float>(a),
