...
static float DILATE_stencil_kernel(float s_1_2, float s_3_2, float s_1_3,
                                   float s_3_3, float s_0_2, float s_3_1,
                                   float s_2_1, float s_2_0, float s_2_4,
                                   float s_2_3, float s_2_2, float s_4_2,
                                   float s_1_1) {
  /*
       ((t10 > t11)?t10:t11)
  */
...
void DILATE(tapa::istream<INTERFACE_WIDTH>& s,
            tapa::ostream<INTERFACE_WIDTH>& y,  // int useless,
            int iters) {
...
#pragma HLS array_partition variable = s_1_1 complete dim = 0
      ...
      uint32_t temp_s_1_2 = (k < 14)
                                ? s_block_256.range(idx_k + 95, idx_k + 64)
                                : s_block_257.range(idx_k + -417, idx_k + -448);
      s_1_2[k] = *((float*)(&temp_s_1_2));
      uint32_t temp_s_3_2 = (k < 14)
                                ? s_block_768.range(idx_k + 95, idx_k + 64)
                                : s_block_769.range(idx_k + -417, idx_k + -448);
      s_3_2[k] = *((float*)(&temp_s_3_2));
      uint32_t temp_s_1_3 = (k < 13)
                                ? s_block_256.range(idx_k + 127, idx_k + 96)
                                : s_block_257.range(idx_k + -385, idx_k + -416);
      s_1_3[k] = *((float*)(&temp_s_1_3));
      uint32_t temp_s_3_3 = (k < 13)
                                ? s_block_768.range(idx_k + 127, idx_k + 96)
                                : s_block_769.range(idx_k + -385, idx_k + -416);
      s_3_3[k] = *((float*)(&temp_s_3_3));
      uint32_t temp_s_0_2 = (k < 14)
                                ? s_block_0.range(idx_k + 95, idx_k + 64)
                                : s_block_1.range(idx_k + -417, idx_k + -448);
      s_0_2[k] = *((float*)(&temp_s_0_2));
      uint32_t temp_s_3_1 = (k < 15)
                                ? s_block_768.range(idx_k + 63, idx_k + 32)
                                : s_block_769.range(idx_k + -449, idx_k + -480);
      s_3_1[k] = *((float*)(&temp_s_3_1));
      uint32_t temp_s_2_1 = (k < 15)
                                ? s_block_512.range(idx_k + 63, idx_k + 32)
                                : s_block_513.range(idx_k + -449, idx_k + -480);
      s_2_1[k] = *((float*)(&temp_s_2_1));
      uint32_t temp_s_2_0 = s_block_512.range(idx_k + 31, idx_k);
      s_2_0[k] = *((float*)(&temp_s_2_0));
      uint32_t temp_s_2_4 = (k < 12)
                                ? s_block_512.range(idx_k + 159, idx_k + 128)
                                : s_block_513.range(idx_k + -353, idx_k + -384);
      s_2_4[k] = *((float*)(&temp_s_2_4));
      uint32_t temp_s_2_3 = (k < 13)
                                ? s_block_512.range(idx_k + 127, idx_k + 96)
                                : s_block_513.range(idx_k + -385, idx_k + -416);
      s_2_3[k] = *((float*)(&temp_s_2_3));
      uint32_t temp_s_2_2 = (k < 14)
                                ? s_block_512.range(idx_k + 95, idx_k + 64)
                                : s_block_513.range(idx_k + -417, idx_k + -448);
      s_2_2[k] = *((float*)(&temp_s_2_2));
      uint32_t temp_s_4_2 =
          (k < 14) ? s_block_1024.range(idx_k + 95, idx_k + 64)
                   : s_block_1025.range(idx_k + -417, idx_k + -448);
      s_4_2[k] = *((float*)(&temp_s_4_2));
      uint32_t temp_s_1_1 = (k < 15)
                                ? s_block_256.range(idx_k + 63, idx_k + 32)
                                : s_block_257.range(idx_k + -449, idx_k + -480);
      s_1_1[k] = *((float*)(&temp_s_1_1));

      float result = DILATE_stencil_kernel(
          s_1_2[k], s_3_2[k], s_1_3[k], s_3_3[k], s_0_2[k], s_3_1[k], s_2_1[k],
          s_2_0[k], s_2_4[k], s_2_3[k], s_2_2[k], s_4_2[k], s_1_1[k]);
...
void load(tapa::async_mmap<INTERFACE_WIDTH>& a,
...
#pragma HLS inline off
  ...
  for (int k_wr_req = (1026), k_wr_resp = (1026), k_rd_req = 0, k_rd_resp = 0;
    ...
    // write to b
    if (k_wr_req < loop_bound && !b.write_addr.full() && !b.write_data.full() &&
        !stream_in.empty()) {
...
// Block reading
void inter_kernel(tapa::async_mmap<INTERFACE_WIDTH>& a,
                  tapa::async_mmap<INTERFACE_WIDTH>& b,
                  tapa::ostream<INTERFACE_WIDTH>& stream_out,
                  tapa::istream<INTERFACE_WIDTH>& stream_in, uint32_t iters) {
