...
void FloatvMultConst(const int alpha_u, tapa::istream<float_v16>& fifo_in,
...
void Sextans(tapa::mmap<int> edge_list_ptr,
  ...
  tapa::task()
      ...
      .invoke<tapa::detach, NUM_CH_C>(FloatvMultConst, beta_u, fifo_C_read_in,
                                      fifo_C_read_in_beta)

      .invoke<tapa::detach, NUM_CH_C>(FloatvMultConst, alpha_u,
