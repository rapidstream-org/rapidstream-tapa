...
void VecAdd(tapa::mmap<float> a_array, tapa::mmap<float> b_array,
...
int main(int argc, char* argv[]) {
  ...
  int64_t kernel_time_ns = tapa::invoke(
      VecAdd, FLAGS_bitstream, tapa::read_write_mmap<float>(a),
      tapa::read_write_mmap<float>(b), tapa::read_write_mmap<float>(c), n);
