...
from rapidstream.graphir.types.commons import NamedModel, NamespaceModel
from rapidstream.graphir.types.modules import AnyModuleDefinition
...
class Modules(NamespaceModel):
    ...
    Example:
        >>> import json
        >>> from rapidstream.graphir.types.modules import StubModuleDefinition
    ...
    def get_submodules_recursive(
        ...
        Example:
            >>> from rapidstream.graphir.types import (
