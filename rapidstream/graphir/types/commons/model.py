"""Base class of immutable objects that is shared among RapidStream types."""
...
class ModelMixin:
    ...
    def updated(self, **update: object) -> Self:  # type: ignore
        ...
        """
        return self._model_copy(deep=False, **update)  # type: ignore

    def _model_copy(self, deep: bool, **update: object) -> Self:  # type: ignore
        ...
        update = self.sanitze_fields(**update)  # type: ignore
    ...
    def get_name_of_object(inst: object | dict[str, object]) -> str:
        ...
        if hasattr(inst, "name"):
            return str(inst.name)  # type: ignore
