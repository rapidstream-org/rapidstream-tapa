"""Data structure to represent an internal module definition for RapidStream to work."""
...
class InternalVerilogModuleDefinition(VerilogModuleDefinition):
    """A definition of an internal verilog module supporting RapidStream.
    ...
    module_type: Literal["internal_verilog_module"] = "internal_verilog_module"  # type: ignore
...
class InternalGroupedModuleDefinition(GroupedModuleDefinition):
    """A definition of an internal grouped module supporting RapidStream.
    ...
    module_type: Literal["internal_grouped_module"] = "internal_grouped_module"  # type: ignore
