...
from rapidstream.graphir.types.modules.supports import ModuleConnection
from rapidstream.graphir.types.modules.supports.port import ModulePort

if TYPE_CHECKING:
    from rapidstream.graphir.types.modules.definitions import AnyModuleDefinition
    ...
    def resolve_parameters(
        ...
        while default_exprs:
            ...
            for name, expr in default_exprs.items():
                if all(id in resolved_exprs for id in expr.get_used_identifiers()):
